...
func NewRocketApp(
	...
	app.bondCurveKeeper = bondcurve.NewKeeper(appCodec, keys[bondcurve.StoreKey], app.bankKeeper, app.ibcKeeper.ChannelKeeper, app.subspaces[bondcurve.ModuleName])
